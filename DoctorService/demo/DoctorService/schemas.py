...
base_path = '/DoctorService'

definitions = {'definitions': {}, 'parameters': {}}

validators = {
    ('DoctorInformation', 'GET'): {'args': {'required': ['Doctor'], 'properties': {'Doctor': {'type': 'string'}}}},
    ('AvailableDoctor', 'GET'): {'args': {'required': ['Date'], 'properties': {'Date': {'type': 'string'}}}},
}

filters = {
    ('AllDoctorInformation', 'GET'): {200: {'headers': None, 'schema': None}, 404: {'headers': None, 'schema': None}},
    ('DoctorInformation', 'GET'): {200: {'headers': None, 'schema': None}, 404: {'headers': None, 'schema': None}, 500: {'headers': None, 'schema': None}},
    ('AvailableDoctor', 'GET'): {200: {'headers': None, 'schema': None}, 404: {'headers': None, 'schema': None}, 500: {'headers': None, 'schema': None}},
}
